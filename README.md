...
In the following predictions we notice that the network is very accuarate by detecting the rear of the cars when the camera only see cars on the same direction. However when the street is two ways and the bounding box is in the right of the image there are missclassifications as expected. Find this resuls in backup_final folder in the drive location as well as the jupyter notebook AI4AV_A9 in COLAB. 

<img src="imgs/pred.jpg" alt="gr3">


<img src="imgs/confusion_matrix.png" alt="gr4">
<img src="imgs/results.png" alt="gr5">
