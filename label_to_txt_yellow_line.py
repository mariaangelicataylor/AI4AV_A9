...
def label2txt(frames, output_dir: Path):
    ...
    for frame in frames:
        ...
        with open(frame_file, "w+") as f:
            ...
            yellow_present = False #dafault there is not yellow lane in the image
            for label in frame["labels"]: #Check every label
                if label["category"] == "lane": #lane present
            ...
            if yellow_present: #Only check to the boxes in the left for car, truck or bus
                ...
                for label in frame["labels"]:
                        ...
                        if lbl < 3: #Check if the label is car, truck or bus
                            box2d = label["box2d"]
